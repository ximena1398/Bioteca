...
VALUES
	('administrador', 'admin', 'admin@gmail.com', '1234', 'administrador');
...
INSERT INTO PERSONA
VALUES
	(1, 'Maria Alejandra', 'Murcia Cometa', 'ma@gmail.com', 'hd8ye');

INSERT INTO PERSONA
VALUES
	(2, 'Ximena', 'Medina Correa', 'xi@gmail.com', 'gs9e3');

INSERT INTO PERSONA
VALUES
	(3, 'leída', 'Martinez Sanchez', 'lema@gmail.com', 'hs8r2');

INSERT INTO PERSONA
VALUES
	(4, 'Yubely', 'Paez Romero', 'yupa@gmail.com', 'nc6sy');

INSERT INTO PERSONA
VALUES
	(5, 'Yamile', 'Rincon Sierra', 'yari@gmail.com', 'gs7ew');

INSERT INTO PERSONA
VALUES
	(6, 'Kevin', 'Plaza Cabrera', 'kepla@gmail.com', 'asp5b');

INSERT INTO PERSONA
VALUES
	(7, 'Jonathan', 'Carvajal', 'jhoca@gmail.com', 'gd645');

INSERT INTO PERSONA
VALUES
	(8, 'Janiel', 'Medina Claros', 'jame@gmail.com', '64hts');

INSERT INTO PERSONA
VALUES
	(9, 'Juan Camilo', 'Ospitia Triviño', 'caos@gmail.com', 'kd83g');

INSERT INTO PERSONA
VALUES
	(10, 'Jose Manuel', 'Ruiz', 'joru@gmail.com', 'ba5fe');

INSERT INTO PERSONA
VALUES
	(11, 'Yeimi Cenaida', 'Castañeda Cardozo', 'yeca@gmail.com', 'ksa72');

INSERT INTO PERSONA
VALUES
	(12, 'Leidy Johana', 'Ramirez', 'lera@gmail.com', 'bc63b');

INSERT INTO PERSONA
VALUES
	(13, 'Daniel', 'Silva', 'dasi@gmail.com', '83gd6');

INSERT INTO PERSONA
VALUES
	(14, 'Valentina', 'Camacho', 'vac@gmail.com', 'te7f5');

INSERT INTO PERSONA
VALUES
	(15, 'Rosa Angelica', 'Cruz', 'rocru@gmail.com', '73tdv');

INSERT INTO PERSONA
VALUES
	(16, 'Jenniffer Maritza', 'Perez Daza', 'jhepe@gmail.com', 'hwq63');

INSERT INTO PERSONA
VALUES
	(17, 'Natalia', 'Medina España', 'name@gmail.com', '84txn');

INSERT INTO PERSONA
VALUES
	(18, 'Maria Isabel', 'Gamboa', 'maga@gmail.com', 'bc4qg');

INSERT INTO PERSONA
VALUES
	(19, 'Karen Geraldine', 'Villarreal', 'kavi@gmail.com', '64t5u');

INSERT INTO PERSONA
VALUES
	(20, 'Alejandro', 'Guevara', 'ague@gmail.com', '63gd5');
...
/*CREATE TRIGGER ActualizarEstado ON documento
FOR INSERT
AS 
DECLARE @nota NUMERIC
SELECT @nota = (SELECT nota_final
	FROM INSERTED)
IF @nota>=3.5
UPDATE DOCUMENTO SET estado_idestado=2
IF @nota<3.5
UPDATE DOCUMENTO SET estado_idestado=3
GO
...
BEGIN
UPDATE DOCUMENTO
IF evaluacion.nota_final > 3.5 && evaluacion.nota_final < 5 THEN
SET documento.estado_idestado = 2
ELSE if evaluacion.nota_final < 3.5
SET documento.estado_idestado = 1
END IF
END;