...
const {controller, session, UsuarioPrincipal, postularDocumento, InformacionDocumento, EvaluadorPrincipal,
     ...
     InformacionDocumentoEvaluador, InformacionDocumentoOut, clasificacion,clasificacionSin, inicio, Buscar}= require('../controllers/index');

//rutas vistas
router.get('/', controller);
router.get('/login', session);
router.get('/index/:id', inicio);
router.get('/index', controller);
...
router.post('/index', clasificacionSin);
